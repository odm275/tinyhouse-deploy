...
const logInViaGoogle = (code, token, db, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.cookie(
      "viewer",
      userId,
      Object.assign(Object.assign({}, cookieOptions), {
        maxAge: 365 * 24 * 60 * 60 * 1000,
      })
    );
    return viewer;
  });
const logInViaCookie = (token, db, req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updateRes = yield db.users.findOneAndUpdate(
...
exports.viewerResolvers = {
  ...
  Mutation: {
    ...
    connectStripe: (_root, { input }, { db, req }) =>
      __awaiter(void 0, void 0, void 0, function* () {
        try {
          const { code } = input;
    ...
    disconnectStripe: (_root, _args, { db, req }) =>
      __awaiter(void 0, void 0, void 0, function* () {
        try {
          let viewer = yield utils_1.authorize(db, req);
          if (!viewer) {
